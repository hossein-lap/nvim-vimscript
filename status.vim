...
"
" Colors {{{ 
hi User1 guifg=#ff7799 guibg=#282a2e " ctermfg=167 ctermbg=232 cterm=bold gui=bold
hi User2 guifg=#00afcc guibg=#282a2e " ctermbg=4   ctermfg=232 cterm=bold gui=bold
hi User3 guifg=#cccccc guibg=#282a2e " ctermbg=4   ctermfg=232 cterm=bold gui=bold
...
set statusline+=%4*\|                  " Separator
set statusline+=%4*\                   " blank space
set statusline+=%4*%l\/%L              " Line count
set statusline+=%4*\                   " blank space
